...
int main (int argc, const char * argv[]) {
    ...
    const char *srcfile="/Users/cobranail/Documents/temp/mt_sourceObjectInfo.txt";
    const char *destfile="/Users/cobranail/Documents/temp/mt_destinationObjectInfo.txt";
    const char *mapper="/Users/cobranail/Documents/temp/mt_mapper.txt";
    const char *outmapper="/Users/cobranail/Documents/temp/mt_outmapper.txt";
...
Face *deleteFaceById(faceList *list,int id){
    ...
    /*
        ...
        while(ptr!=NULL){
            ...
            if (list->faces->id==id){ //only one face
            
                dptr=list->faces;
                list->faces=list->faces->next;
                return dptr;
            }
...
void mapAllFV(int *smappedFaceArray, int *smappedVtxArray, int *dmappedFaceArray, int *dmappedVtxArray, int *FEinfo, faceList *srclist, faceList *destlist, int *mapper) {
	...
	int fp=0, vp=0, i=0, j=0, sfid=0, dfid=0;
	int n=0;
